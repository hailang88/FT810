...
ESD_WIDGET(Ft_Esd_ScrollPanel, Include = "Ft_Esd_ScrollPanel.h", Callback, DisplayName = "ESD Scroll Panel", Category = EsdWidgets, Icon = ":/icons/ui-scroll-pane.png", X = 50, Y = 50, Width = 200, Height = 150, Layout)
typedef struct
{
	union
	{
	...
	ESD_VARIABLE(ScrollBars, Type = Esd_Visible, Default = ESD_VISIBLE_WHENNEEDED, Public)
