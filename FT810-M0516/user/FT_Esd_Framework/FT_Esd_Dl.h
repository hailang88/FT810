...
ESD_PARAMETER(s, Type = ft_uint8_t, DisplayName = "Tag", Default = 255, Min = 0, Max = 255)
 static ft_void_t Ft_Esd_Dl_TAG(ft_uint8_t s)
{
...
ESD_PARAMETER(c, Type = ft_rgb32_t, DisplayName = "Color")
 static ft_void_t Ft_Esd_Dl_COLOR_RGB(ft_rgb32_t c)
{
...
ESD_PARAMETER(alpha, Type = ft_uint8_t, Default = 255, Min = 0, Max = 255)
 static ft_void_t Ft_Esd_Dl_COLOR_A(ft_uint8_t alpha)
{
#if FT_ESD_OPTIMIZE_DISPLAYLIST
...
ESD_PARAMETER(c, Type = ft_argb32_t, DisplayName = "Color")
 static ft_void_t Ft_Esd_Dl_COLOR_ARGB(ft_uint32_t c)
{
...
ESD_PARAMETER(handle, Type = ft_uint8_t, Min = 0, Max = 31)
 static ft_void_t Ft_Esd_Dl_BITMAP_HANDLE(ft_uint8_t handle)
{
#if FT_ESD_OPTIMIZE_DISPLAYLIST
...
ESD_PARAMETER(cell, Type = ft_uint8_t, Min = 0, Max = 255)
 static ft_void_t Ft_Esd_Dl_CELL(ft_uint8_t cell)
{
#if FT_ESD_OPTIMIZE_DISPLAYLIST
...
ESD_PARAMETER(ref, Type = ft_uint8_t, Min = 0, Max = 255)
 static ft_void_t Ft_Esd_Dl_Alpha_Func(ft_uint8_t func, ft_uint8_t ref)
{
...
ESD_FUNCTION(Ft_Esd_Dl_SAVE_CONTEXT, Type = ft_void_t, Category = EveRenderFunctions, Inline)
 static ft_void_t Ft_Esd_Dl_SAVE_CONTEXT()
{
...
ESD_FUNCTION(Ft_Esd_Dl_RESTORE_CONTEXT, Type = ft_void_t, Category = EveRenderFunctions, Inline)
 static ft_void_t Ft_Esd_Dl_RESTORE_CONTEXT()
{
...
ESD_PARAMETER(frac, Type = ft_uint8_t, Min = 0, Max = 4)
 static ft_void_t Ft_Esd_Dl_VERTEX_FORMAT(ft_uint8_t frac)
{
#if FT_ESD_OPTIMIZE_DISPLAYLIST
...
ESD_PARAMETER(addr, Type = ft_uint32_t, Min = 0)
 static ft_void_t Ft_Esd_Dl_PALETTE_SOURCE(ft_uint32_t addr)
{
#if FT_ESD_OPTIMIZE_DISPLAYLIST
...
ESD_PARAMETER(width, Type = ft_int32_f4_t)
 static ft_void_t Ft_Esd_Dl_LINE_WIDTH(ft_int32_f4_t width) { Ft_Gpu_Hal_WrCmd32(Ft_Esd_Host, LINE_WIDTH(width)); }
